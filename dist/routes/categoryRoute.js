...
router.post("/create-category", authorization_1.verifyToken, (req, res) => {
    categoryController.createCategoryController(req, res);
});
router.get("/get-category", authorization_1.verifyToken, (req, res) => {
    categoryController.getCategoriesController(req, res);
});
router.put("/update-category", authorization_1.verifyToken, (req, res) => {
    categoryController.updateCategoryController(req, res);
});
router.delete("/delet-category", authorization_1.verifyToken, (req, res) => {
